...
* Create a new Amplify Fusion project for this CRM cloud integration. Use a unique name in case you're not the only one doing this lab on your tenant (e.g. XX_Salesforce2Hubspot with XX being your name or initials).
