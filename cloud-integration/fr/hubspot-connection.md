...
* Si vous n'avez pas de compte Hubspot, créez en un à l'adresse suivante: **[https://www.hubspot.com/](https://www.hubspot.com/)**. Passez tous les écrans de bienvenu jusqu'à atteindre la page d'accueil de Hubspot
  ![hubspot00](../assets/../assets/hubspot-connection/hubspot00.png)
* Si vous n'avez pas d'App de développeur Hubspot, créez en une à l'adresse suivante: [**https://developers.hubspot.com/**](https://developers.hubspot.com/) , choisissez l'option App Developer et passez tous les écrans de bienvenu jusqu'à atteindre la page d'accueil de développeur Hubspot
...
* Faites défiler vers le bas jusqu'à la section Scopes et sélectionnez les scopes souhaités. Par exemple, voici les Scopes CRM sélectionnés pour cet exemple:
...
* Entrez votre Client ID, Client Secret et la Scope list provenant des étapes précédentes puis cliquez sur Update
  ![hubspot08](../assets/hubspot-connection/hubspot08.png)
* Cliquez sur Genrate Token pour vous authentifier, renseignez vos informations de connexion, sélectionnez votre compte non-développeur puis cliquez sur choose Account
...
Votre connexion peut désormais être utilisé dans une intégration. Mais pour commencer testons-la

## Test de la Connexion

* Créez une intégration et ajoutez un évènement Scheduler trigger et réglez le à n'importe quelle valeur étant donné que nous n'allons pas l'activer
