...
* Désactiver les deux intégrations lorsqu'elles ne sont `+`utilisées afin d'éviter les requêtes répétitives.

## Étape 3 - Relevez le défi!

Utiliser l'exemple de carte MS Teams suivant, le modifier afin d'avoir une carte MS Teams `+`esthétique pour vos factures, puis l'envoyer en tant que body pour votre HTTPS Client Post vers MS Teams:
